...
public class EvaluationResult {
    ...
    private final boolean passed;        // simple sanity: ≥1 result for majority of users

    // Scenario
    private final String scenario;       // "best", "worst", "average"

    // Constructor
    public EvaluationResult(
            String algorithmName, String versionLabel,
    ...
    public double  getExecTimeMs()                { return execTimeNs / 1_000_000.0; }
    public long    getOpCountSimilarity()         { return opCountSimilarity; }
    public long    getOpCountHeap()               { return opCountHeap; }
    public long    getOpCountScore()              { return opCountScore; }
    public long    getOpCountTotal()              { return opCountSimilarity + opCountHeap + opCountScore; }
    public long    getOpCountCacheHit()           { return opCountCacheHit; }
    public long    getOpCountCacheMiss()          { return opCountCacheMiss; }
    public long    getExtraMemoryBytes()          { return extraMemoryBytes; }
    public double  getExtraMemoryKB()             { return extraMemoryBytes / 1024.0; }
    public double  getExtraMemoryMB()             { return extraMemoryBytes / (1024.0 * 1024.0); }
    public int     getUsersWithRecommendations()  { return usersWithRecommendations; }
    public int     getTotalUsersEvaluated()       { return totalUsersEvaluated; }
